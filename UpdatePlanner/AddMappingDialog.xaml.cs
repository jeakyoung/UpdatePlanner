...
namespace UpdatePlanner
{
    public partial class AddMappingDialog : Window
    {
        ...
        public AddMappingDialog(MappingType type)
        {
            ...
            {
                Title              = "배포 폴더 추가";
                LblSource.Content  = "업데이트 폴더:";
                TxtSource.ToolTip  = "하위 파일 전체를 배포할 소스 폴더";
            }
            else
            {
                Title              = "배포 파일 추가";
                LblSource.Content  = "업데이트 파일:";
        ...
        private void BtnOk_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                string label = _type == MappingType.Folder ? "업데이트 폴더" : "업데이트 파일";
            ...
            {
                MessageBox.Show("업데이트 폴더가 존재하지 않습니다.", "입력 오류",
                    MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            {
                MessageBox.Show("업데이트 파일이 존재하지 않습니다.", "입력 오류",
                    MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
